...
contactInfo = """
## For any Queries:-
### You could connect with me on [LinkedIn](https://www.linkedin.com/in/zynatyusuf/) or could mail me [here](mailto:yusufzinatu@gmail.com)
"""
...
def sidebar_conf():
    sidebar = st.sidebar
    sidebar.title("Zgenerator - A user friendly article generator bot")
    sidebar.divider()
    ...
    sidebar.markdown("# Made with ❤️ by Zynat")
